...
class CNNModel:
    ...
    def save_weights(self, path='cnn_fashion.weights.h5'): #pesos finais sao salvos para nao termos que refazer o treino toda vez que quisermos usar a rede
        self.model.save_weights(path)

    def load_weights(self, path='cnn_fashion.weights.h5'): #carrega peso salvo
